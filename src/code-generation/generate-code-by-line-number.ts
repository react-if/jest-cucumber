...
const findObjectByLineNumber = (
    ...
    let found: any = null,
        type: ObjectTypeEnum = ObjectTypeEnum.scenario;
    ...
    feature.scenarioOutlines.forEach((scenarioOutline) => {
        ...
        scenarioOutline.steps.forEach((step, index) => {
            ...
            if (step.lineNumber === lineNumber) {
                ...
                found = {'steps': scenarioOutline.steps,
                    index};
...
export const generateCodeFromFeature = (
    ...
    const objectAtLine = findObjectByLineNumber(
        feature,
        lineNumber
    );
    ...
    case ObjectTypeEnum.step:
        return generateStepCode(
            objectAtLine.object.steps,
            objectAtLine.object.index,
            false
        );
